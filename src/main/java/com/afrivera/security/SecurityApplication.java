package com.afrivera.security;

import com.afrivera.security.persistence.entity.PermissionEntity;
import com.afrivera.security.persistence.entity.RoleEntity;
import com.afrivera.security.persistence.entity.RoleEnum;
...
public class SecurityApplication {
	...
	CommandLineRunner init(UserServiceImpl userService, PasswordEncoder passwordEncoder){
		return args -> {
			...
			userService.saveInitUsers(List.of(userSantiago, userDaniel, userAndrea, userAnyi));
